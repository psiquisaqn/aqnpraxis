...
// ============================================================
// FIX 1: BDI-2 - redirigir a informe en vez de dashboard
// ============================================================
...
console.log('bdi2 redirect OK')

// ============================================================
// FIX 2: Coopersmith report - leer de coopersmith_scores
// ============================================================
const cooperReport = `'use client'
...
`
fs.writeFileSync('app/coopersmith/[sessionId]/report/page.tsx', cooperReport, 'utf8')
console.log('coopersmith report OK')

// ============================================================
// FIX 3: BDI-2 report - leer de bdi2_scores
// ============================================================
const bdi2Report = `'use client'
import { useEffect, useState } from 'react'
import { useParams, useRouter } from 'next/navigation'
import { supabase } from '@/lib/supabase/client'
...
`
fs.writeFileSync('app/bdi2/[sessionId]/report/page.tsx', bdi2Report, 'utf8')
console.log('bdi2 report OK')
