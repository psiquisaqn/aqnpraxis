...
CREATE TABLE public.bdi2_scores (
  ...
  item_11 smallint CHECK (item_11 BETWEEN 0 AND 3),
  item_12 smallint CHECK (item_12 BETWEEN 0 AND 3),
  item_13 smallint CHECK (item_13 BETWEEN 0 AND 3),
  item_14 smallint CHECK (item_14 BETWEEN 0 AND 3),
  item_15 smallint CHECK (item_15 BETWEEN 0 AND 3),
  item_16 smallint CHECK (item_16 BETWEEN 0 AND 3),
  item_17 smallint CHECK (item_17 BETWEEN 0 AND 3),
  item_18 smallint CHECK (item_18 BETWEEN 0 AND 3),
  item_19 smallint CHECK (item_19 BETWEEN 0 AND 3),
  item_20 smallint CHECK (item_20 BETWEEN 0 AND 3),
  item_21 smallint CHECK (item_21 BETWEEN 0 AND 3),
