...
CREATE TABLE public.bdi2_scores (
  ...
  item_1 smallint CHECK (i01 BETWEEN 0 AND 3),
  item_2 smallint CHECK (i02 BETWEEN 0 AND 3),
  item_3 smallint CHECK (i03 BETWEEN 0 AND 3),
  item_4 smallint CHECK (i04 BETWEEN 0 AND 3),
  item_5 smallint CHECK (i05 BETWEEN 0 AND 3),
  item_6 smallint CHECK (i06 BETWEEN 0 AND 3),
  item_7 smallint CHECK (i07 BETWEEN 0 AND 3),
  item_8 smallint CHECK (i08 BETWEEN 0 AND 3),
  item_9 smallint CHECK (i09 BETWEEN 0 AND 3),
  item_10 smallint CHECK (i10 BETWEEN 0 AND 3),
  item_11 smallint CHECK (i11 BETWEEN 0 AND 3),
  item_12 smallint CHECK (i12 BETWEEN 0 AND 3),
  item_13 smallint CHECK (i13 BETWEEN 0 AND 3),
  item_14 smallint CHECK (i14 BETWEEN 0 AND 3),
  item_15 smallint CHECK (i15 BETWEEN 0 AND 3),
  item_16 smallint CHECK (i16 BETWEEN 0 AND 3),
  item_17 smallint CHECK (i17 BETWEEN 0 AND 3),
  item_18 smallint CHECK (i18 BETWEEN 0 AND 3),
  item_19 smallint CHECK (i19 BETWEEN 0 AND 3),
  item_20 smallint CHECK (i20 BETWEEN 0 AND 3),
  item_21 smallint CHECK (i21 BETWEEN 0 AND 3),
