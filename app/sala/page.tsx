...
export default function SalaPage() {
  ...
  const [dualSession, setDualSession] = useState<any>(null)
  ...
  useEffect(() => {
    const loadSession = async () => {
      try {
        ...
        // Buscar en dual_sessions por room_code
        ...
        if (dualError) {
          ...
          setError(`Sala no encontrada. Código: ${code}`)
          setLoading(false)
          return
        }
    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 text-center">
          <a href="/sala" className="text-sm text-gray-500 hover:text-gray-700">
            ← Cambiar de sala
          </a>
        </div>
      </div>
