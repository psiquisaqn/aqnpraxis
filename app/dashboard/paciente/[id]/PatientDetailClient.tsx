...
export function PatientDetailClient({ data }: Props) {
  ...
  return (
    <>
      <div className="px-8 py-8 max-w-4xl">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
                {[
                  ...
                  { label: 'Establecimiento', value: patient.school ?? '—' },
              ...
              {patient.notes && (
                ...
                >
                  <span className="font-medium text-xs uppercase tracking-wide" style={{ color: 'var(--stone-400)' }}>Notas · </span>
                  {patient.notes}
                </div>
              )}
            </div>
          ...
          {TABS.map((t) => (
            ...
            >
              ...
              {t.key === 'sessions' && sessions.length > 0 && (
                <span className="ml-1.5 text-xs px-1.5 py-0.5 rounded-full" style={{ background: 'var(--stone-100)', color: 'var(--stone-500)' }}>
                  {sessions.length}
                </span>
              )}
        ...
        {tab === 'programs'  && <ProgramsTab patientId={patient.id} activities={activities} />}
